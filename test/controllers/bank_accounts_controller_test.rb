...
class BankAccountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank_account" do
    assert_difference('BankAccount.count') do
      post bank_accounts_url, params: { bank_account: { account_type: @bank_account.account_type, bank_account_no: @bank_account.bank_account_no, bank_name: @bank_account.bank_name, personal_detail_id: @bank_account.personal_detail_id } }
    end
  ...
  test "should update bank_account" do
    patch bank_account_url(@bank_account), params: { bank_account: { account_type: @bank_account.account_type, bank_account_no: @bank_account.bank_account_no, bank_name: @bank_account.bank_name, personal_detail_id: @bank_account.personal_detail_id } }
