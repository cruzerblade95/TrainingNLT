...
class ChildrenTest < ApplicationSystemTestCase
  ...
  test "creating a Child" do
    ...
    fill_in "Children age", with: @child.children_age
    fill_in "Children name", with: @child.children_name
    fill_in "Children nric", with: @child.children_nric
    fill_in "Children sex", with: @child.children_sex
    fill_in "Personal detail", with: @child.personal_detail_id
