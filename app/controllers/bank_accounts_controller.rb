class BankAccountsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @bank_account.save
        format.html { redirect_to staff_register7_path, notice: 'Children was added.' }
  ...
  private
    ...
    def bank_account_params
      params.require(:bank_account).permit(:bank_name, :bank_account_no, :account_type, :personal_detail_id)
    end
end
